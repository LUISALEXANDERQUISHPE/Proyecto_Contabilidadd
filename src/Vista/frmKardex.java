...
import Clases.MySql;
import Controlador.ControlKardex;
...
public class frmKardex extends javax.swing.JFrame {
    ...
    ControlKardex ctKarx = new ControlKardex();
    AlmacenProductos almaProduc = new AlmacenProductos();
    AlmacenKardex almaKar = new AlmacenKardex();
    ...
    public frmKardex() {
        ...
        String[] titulo = new String[]{"FECHA", "MOVIMIENTO", "ENTRADA", "SALIDA", "DISPONIBLE"};
        dtm.setColumnIdentifiers(titulo);
        tbDatos.setModel(dtm);
        ctKarx.cargarProducto(this.cbProductos, almaProduc);
        cbProductos.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (cbProductos.getItemCount() > 0) {
                    ...
                    // Eliminar las filas 
                    dtm.setRowCount(0);
                    // Llamamos al método para cargar los nuevos datos en el DefaultTableModel
                    ctKarx.Insertarkardex(almaKar, dtm, codigoProducto);
                }
            }
        });
    ...
    private void initComponents() {
        ...
        tbProductos.setBorder(javax.swing.BorderFactory.createTitledBorder("\"UNIDADES\""));
        ...
        jPanel1.add(tbProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 760, 250));

        bt.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        bt.setForeground(new java.awt.Color(0, 0, 0));
        bt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/house.png"))); // NOI18N
        bt.setText("    Menú");
        bt.setToolTipText("");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/KARDEX.png"))); // NOI18N
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 110, 20));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 210, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/toyota.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 450, 60, 60));
        ...
        jPanel1.add(cbProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 170, 30));

        jLabel15.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel15.setText("Movimientos.");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 110, 20));
